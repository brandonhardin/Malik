...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/Users/brandonhardin/anaconda/lib/python3.6/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/Users/brandonhardin/anaconda/lib/python3.6/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ],
        "include_dirs": [
...
#define __PYX_HAVE__malik__engine
#define __PYX_HAVE_API__malik__engine
#include <math.h>
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/*--- Type declarations ---*/
struct __pyx_obj_5malik_6payoff_Payoff;
struct __pyx_obj_5malik_6payoff_VanillaCallPayoff;
struct __pyx_obj_5malik_6payoff_VanillaPutPayoff;
struct __pyx_obj_5malik_6option_Option;
struct __pyx_obj_5malik_10marketdata_MarketData;
struct __pyx_obj_5malik_10marketdata_HestonData;
struct __pyx_obj_5malik_6engine_PricingEngine;
struct __pyx_obj_5malik_6engine_BinomialEngine;
struct __pyx_obj_5malik_6engine_EuropeanBinomialEngine;
 ...
 */
struct __pyx_obj_5malik_6payoff_VanillaCallPayoff {
  struct __pyx_obj_5malik_6payoff_Payoff __pyx_base;
  struct __pyx_vtabstruct_5malik_6payoff_VanillaCallPayoff *__pyx_vtab;
};
...
struct __pyx_obj_5malik_6payoff_VanillaPutPayoff {
  struct __pyx_obj_5malik_6payoff_Payoff __pyx_base;
  struct __pyx_vtabstruct_5malik_6payoff_VanillaPutPayoff *__pyx_vtab;
};
...
struct __pyx_obj_5malik_6option_Option {
  PyObject_HEAD
  struct __pyx_vtabstruct_5malik_6option_Option *__pyx_vtab;
  double _expiry;
  struct __pyx_obj_5malik_6payoff_Payoff *_payoff;
};
...
struct __pyx_obj_5malik_6engine_PricingEngine {
  PyObject_HEAD
  struct __pyx_vtabstruct_5malik_6engine_PricingEngine *__pyx_vtab;
};
 ...
 */
struct __pyx_obj_5malik_6engine_BinomialEngine {
  struct __pyx_obj_5malik_6engine_PricingEngine __pyx_base;
 ...
 */
struct __pyx_obj_5malik_6engine_EuropeanBinomialEngine {
  struct __pyx_obj_5malik_6engine_BinomialEngine __pyx_base;
};
...
struct __pyx_vtabstruct_5malik_6payoff_VanillaCallPayoff {
  PyObject *(*payoff)(struct __pyx_obj_5malik_6payoff_VanillaCallPayoff *, double, int __pyx_skip_dispatch);
};
static struct __pyx_vtabstruct_5malik_6payoff_VanillaCallPayoff *__pyx_vtabptr_5malik_6payoff_VanillaCallPayoff;
...
struct __pyx_vtabstruct_5malik_6payoff_VanillaPutPayoff {
  PyObject *(*payoff)(struct __pyx_obj_5malik_6payoff_VanillaPutPayoff *, double, int __pyx_skip_dispatch);
};
static struct __pyx_vtabstruct_5malik_6payoff_VanillaPutPayoff *__pyx_vtabptr_5malik_6payoff_VanillaPutPayoff;
...
struct __pyx_vtabstruct_5malik_6option_Option {
  PyObject *(*payoff)(struct __pyx_obj_5malik_6option_Option *, double, int __pyx_skip_dispatch);
};
static struct __pyx_vtabstruct_5malik_6option_Option *__pyx_vtabptr_5malik_6option_Option;
...
struct __pyx_vtabstruct_5malik_6engine_PricingEngine {
  double (*calculate)(struct __pyx_obj_5malik_6engine_PricingEngine *, struct __pyx_obj_5malik_6option_Option *, struct __pyx_obj_5malik_10marketdata_MarketData *);
};
static struct __pyx_vtabstruct_5malik_6engine_PricingEngine *__pyx_vtabptr_5malik_6engine_PricingEngine;
...
struct __pyx_vtabstruct_5malik_6engine_BinomialEngine {
  struct __pyx_vtabstruct_5malik_6engine_PricingEngine __pyx_base;
};
static struct __pyx_vtabstruct_5malik_6engine_BinomialEngine *__pyx_vtabptr_5malik_6engine_BinomialEngine;
...
struct __pyx_vtabstruct_5malik_6engine_EuropeanBinomialEngine {
  struct __pyx_vtabstruct_5malik_6engine_BinomialEngine __pyx_base;
};
static struct __pyx_vtabstruct_5malik_6engine_EuropeanBinomialEngine *__pyx_vtabptr_5malik_6engine_EuropeanBinomialEngine;
...
static double __pyx_f_5malik_6engine_13PricingEngine_calculate(CYTHON_UNUSED struct __pyx_obj_5malik_6engine_PricingEngine *__pyx_v_self, CYTHON_UNUSED struct __pyx_obj_5malik_6option_Option *__pyx_v_option, CYTHON_UNUSED struct __pyx_obj_5malik_10marketdata_MarketData *__pyx_v_data); /* proto*/
static double __pyx_f_5malik_6engine_14BinomialEngine_calculate(CYTHON_UNUSED struct __pyx_obj_5malik_6engine_BinomialEngine *__pyx_v_self, CYTHON_UNUSED struct __pyx_obj_5malik_6option_Option *__pyx_v_option, CYTHON_UNUSED struct __pyx_obj_5malik_10marketdata_MarketData *__pyx_v_data); /* proto*/
static double __pyx_f_5malik_6engine_22EuropeanBinomialEngine_calculate(struct __pyx_obj_5malik_6engine_EuropeanBinomialEngine *__pyx_v_self, struct __pyx_obj_5malik_6option_Option *__pyx_v_option, struct __pyx_obj_5malik_10marketdata_MarketData *__pyx_v_data); /* proto*/

/* Module declarations from 'malik' */

/* Module declarations from 'malik.payoff' */
static PyTypeObject *__pyx_ptype_5malik_6payoff_Payoff = 0;
static PyTypeObject *__pyx_ptype_5malik_6payoff_VanillaCallPayoff = 0;
static PyTypeObject *__pyx_ptype_5malik_6payoff_VanillaPutPayoff = 0;

/* Module declarations from 'malik.option' */
static PyTypeObject *__pyx_ptype_5malik_6option_Option = 0;
...
/* Module declarations from 'malik.engine' */
static PyTypeObject *__pyx_ptype_5malik_6engine_PricingEngine = 0;
static PyTypeObject *__pyx_ptype_5malik_6engine_BinomialEngine = 0;
static PyTypeObject *__pyx_ptype_5malik_6engine_EuropeanBinomialEngine = 0;
#define __Pyx_MODULE_NAME "malik.engine"
int __pyx_module_is_main_malik__engine = 0;

/* Implementation of 'malik.engine' */
...
static int __pyx_pf_5malik_6engine_14BinomialEngine___init__(struct __pyx_obj_5malik_6engine_BinomialEngine *__pyx_v_self, PyObject *__pyx_v_nsteps); /* proto */
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags); /* proto */
static void __pyx_pf_5numpy_7ndarray_2__releasebuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info); /* proto */
static PyObject *__pyx_tp_new_5malik_6engine_PricingEngine(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
static PyObject *__pyx_tp_new_5malik_6engine_BinomialEngine(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
static PyObject *__pyx_tp_new_5malik_6engine_EuropeanBinomialEngine(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
static double __pyx_f_5malik_6engine_13PricingEngine_calculate(CYTHON_UNUSED struct __pyx_obj_5malik_6engine_PricingEngine *__pyx_v_self, CYTHON_UNUSED struct __pyx_obj_5malik_6option_Option *__pyx_v_option, CYTHON_UNUSED struct __pyx_obj_5malik_10marketdata_MarketData *__pyx_v_data) {
  double __pyx_r;
...
/* Python wrapper */
static int __pyx_pw_5malik_6engine_14BinomialEngine_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_5malik_6engine_14BinomialEngine_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("malik.engine.BinomialEngine.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5malik_6engine_14BinomialEngine___init__(((struct __pyx_obj_5malik_6engine_BinomialEngine *)__pyx_v_self), __pyx_v_nsteps);
...
static int __pyx_pf_5malik_6engine_14BinomialEngine___init__(struct __pyx_obj_5malik_6engine_BinomialEngine *__pyx_v_self, PyObject *__pyx_v_nsteps) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 *     cdef double calculate(self, option.Option option , marketdata.MarketData data):
 */
  __pyx_t_1 = __Pyx_PyInt_As_unsigned_long(__pyx_v_nsteps); if (unlikely((__pyx_t_1 == (unsigned long)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L1_error)
...
static double __pyx_f_5malik_6engine_14BinomialEngine_calculate(CYTHON_UNUSED struct __pyx_obj_5malik_6engine_BinomialEngine *__pyx_v_self, CYTHON_UNUSED struct __pyx_obj_5malik_6option_Option *__pyx_v_option, CYTHON_UNUSED struct __pyx_obj_5malik_10marketdata_MarketData *__pyx_v_data) {
  double __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calculate", 0);
...
static double __pyx_f_5malik_6engine_22EuropeanBinomialEngine_calculate(struct __pyx_obj_5malik_6engine_EuropeanBinomialEngine *__pyx_v_self, struct __pyx_obj_5malik_6option_Option *__pyx_v_option, struct __pyx_obj_5malik_10marketdata_MarketData *__pyx_v_data) {
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_option), __pyx_n_s_expiry); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_option), __pyx_n_s_strike); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_data), __pyx_n_s_spot); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_data), __pyx_n_s_rate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_data), __pyx_n_s_vol); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_data), __pyx_n_s_div); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_v_disc = exp(((-__pyx_v_rate) * __pyx_v_expiry));
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_nodes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_4, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
    __pyx_t_1 = PyFloat_FromDouble(__pyx_v_spot); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_7 = PyFloat_FromDouble(__pyx_v_u); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_8 = __Pyx_PyInt_From_unsigned_long(__pyx_v_self->__pyx_base._nsteps); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = PyNumber_Subtract(__pyx_t_8, __pyx_v_i); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = PyNumber_Power(__pyx_t_7, __pyx_t_9, Py_None); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = PyFloat_FromDouble(__pyx_v_d); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_7 = PyNumber_Power(__pyx_t_9, __pyx_v_i, Py_None); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = PyNumber_Multiply(__pyx_t_8, __pyx_t_7); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = PyNumber_Multiply(__pyx_t_1, __pyx_t_9); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_v_spot_t = __pyx_t_3;
 ...
 */
    __pyx_t_7 = PyFloat_FromDouble(__pyx_v_payoff_t); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_9 = ((struct __pyx_vtabstruct_5malik_6option_Option *)__pyx_v_option->__pyx_vtab)->payoff(__pyx_v_option, __pyx_v_spot_t, 0); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_8 = __Pyx_GetModuleGlobalName(__pyx_n_s_binom); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_pmf); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyInt_From_unsigned_long(__pyx_v_self->__pyx_base._nsteps); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_11 = PyNumber_Subtract(__pyx_t_8, __pyx_v_i); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyInt_From_unsigned_long(__pyx_v_self->__pyx_base._nsteps); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_12 = PyFloat_FromDouble(__pyx_v_pu); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 43, __pyx_L1_error)
    ...
    if (PyFunction_Check(__pyx_t_10)) {
      PyObject *__pyx_temp[4] = {__pyx_t_13, __pyx_t_11, __pyx_t_8, __pyx_t_12};
      __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_10, __pyx_temp+1-__pyx_t_14, 3+__pyx_t_14); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_10)) {
      PyObject *__pyx_temp[4] = {__pyx_t_13, __pyx_t_11, __pyx_t_8, __pyx_t_12};
      __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_10, __pyx_temp+1-__pyx_t_14, 3+__pyx_t_14); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_13); __pyx_t_13 = 0;
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    ...
    #endif
    {
      __pyx_t_15 = PyTuple_New(3+__pyx_t_14); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 43, __pyx_L1_error)
      ...
      __pyx_t_8 = 0;
      __pyx_t_12 = 0;
      __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_10, __pyx_t_15, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
    }
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __pyx_t_10 = PyNumber_Multiply(__pyx_t_9, __pyx_t_1); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = PyNumber_InPlaceAdd(__pyx_t_7, __pyx_t_10); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
 ...
 *         return disc * payoff_t             # <<<<<<<<<<<<<<
 */
  __pyx_r = (__pyx_v_disc * __pyx_v_payoff_t);
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_WriteUnraisable("malik.engine.EuropeanBinomialEngine.calculate", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static struct __pyx_vtabstruct_5malik_6engine_PricingEngine __pyx_vtable_5malik_6engine_PricingEngine;

static PyObject *__pyx_tp_new_5malik_6engine_PricingEngine(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_5malik_6engine_PricingEngine *p;
  PyObject *o;
  ...
  p = ((struct __pyx_obj_5malik_6engine_PricingEngine *)o);
  p->__pyx_vtab = __pyx_vtabptr_5malik_6engine_PricingEngine;
  return o;
}

static void __pyx_tp_dealloc_5malik_6engine_PricingEngine(PyObject *o) {
...
static PyTypeObject __pyx_type_5malik_6engine_PricingEngine = {
  PyVarObject_HEAD_INIT(0, 0)
  "malik.engine.PricingEngine", /*tp_name*/
  sizeof(struct __pyx_obj_5malik_6engine_PricingEngine), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_5malik_6engine_PricingEngine, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_5malik_6engine_PricingEngine, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static struct __pyx_vtabstruct_5malik_6engine_BinomialEngine __pyx_vtable_5malik_6engine_BinomialEngine;

static PyObject *__pyx_tp_new_5malik_6engine_BinomialEngine(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_5malik_6engine_BinomialEngine *p;
  PyObject *o = __pyx_tp_new_5malik_6engine_PricingEngine(t, a, k);
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_5malik_6engine_BinomialEngine *)o);
  p->__pyx_base.__pyx_vtab = (struct __pyx_vtabstruct_5malik_6engine_PricingEngine*)__pyx_vtabptr_5malik_6engine_BinomialEngine;
  return o;
}

static PyMethodDef __pyx_methods_5malik_6engine_BinomialEngine[] = {
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_5malik_6engine_BinomialEngine = {
  PyVarObject_HEAD_INIT(0, 0)
  "malik.engine.BinomialEngine", /*tp_name*/
  sizeof(struct __pyx_obj_5malik_6engine_BinomialEngine), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_5malik_6engine_PricingEngine, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  ...
  0, /*tp_as_buffer*/
  Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_VERSION_TAG|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_HAVE_NEWBUFFER|Py_TPFLAGS_BASETYPE, /*tp_flags*/
  "An interface class for binomial pricing models.", /*tp_doc*/
  0, /*tp_traverse*/
  0, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_5malik_6engine_BinomialEngine, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pw_5malik_6engine_14BinomialEngine_1__init__, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_5malik_6engine_BinomialEngine, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static struct __pyx_vtabstruct_5malik_6engine_EuropeanBinomialEngine __pyx_vtable_5malik_6engine_EuropeanBinomialEngine;

static PyObject *__pyx_tp_new_5malik_6engine_EuropeanBinomialEngine(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_5malik_6engine_EuropeanBinomialEngine *p;
  PyObject *o = __pyx_tp_new_5malik_6engine_BinomialEngine(t, a, k);
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_5malik_6engine_EuropeanBinomialEngine *)o);
  p->__pyx_base.__pyx_base.__pyx_vtab = (struct __pyx_vtabstruct_5malik_6engine_PricingEngine*)__pyx_vtabptr_5malik_6engine_EuropeanBinomialEngine;
  return o;
}

static PyTypeObject __pyx_type_5malik_6engine_EuropeanBinomialEngine = {
  PyVarObject_HEAD_INIT(0, 0)
  "malik.engine.EuropeanBinomialEngine", /*tp_name*/
  sizeof(struct __pyx_obj_5malik_6engine_EuropeanBinomialEngine), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_5malik_6engine_PricingEngine, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  ...
  #endif
  0, /*tp_alloc*/
  __pyx_tp_new_5malik_6engine_EuropeanBinomialEngine, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_malik__engine) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "malik.engine")) {
      if (unlikely(PyDict_SetItemString(modules, "malik.engine", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  __pyx_vtabptr_5malik_6engine_PricingEngine = &__pyx_vtable_5malik_6engine_PricingEngine;
  __pyx_vtable_5malik_6engine_PricingEngine.calculate = (double (*)(struct __pyx_obj_5malik_6engine_PricingEngine *, struct __pyx_obj_5malik_6option_Option *, struct __pyx_obj_5malik_10marketdata_MarketData *))__pyx_f_5malik_6engine_13PricingEngine_calculate;
  if (PyType_Ready(&__pyx_type_5malik_6engine_PricingEngine) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __pyx_type_5malik_6engine_PricingEngine.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5malik_6engine_PricingEngine.tp_dict, __pyx_vtabptr_5malik_6engine_PricingEngine) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  if (PyObject_SetAttrString(__pyx_m, "PricingEngine", (PyObject *)&__pyx_type_5malik_6engine_PricingEngine) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __pyx_ptype_5malik_6engine_PricingEngine = &__pyx_type_5malik_6engine_PricingEngine;
  __pyx_vtabptr_5malik_6engine_BinomialEngine = &__pyx_vtable_5malik_6engine_BinomialEngine;
  __pyx_vtable_5malik_6engine_BinomialEngine.__pyx_base = *__pyx_vtabptr_5malik_6engine_PricingEngine;
  __pyx_vtable_5malik_6engine_BinomialEngine.__pyx_base.calculate = (double (*)(struct __pyx_obj_5malik_6engine_PricingEngine *, struct __pyx_obj_5malik_6option_Option *, struct __pyx_obj_5malik_10marketdata_MarketData *))__pyx_f_5malik_6engine_14BinomialEngine_calculate;
  __pyx_type_5malik_6engine_BinomialEngine.tp_base = __pyx_ptype_5malik_6engine_PricingEngine;
  if (PyType_Ready(&__pyx_type_5malik_6engine_BinomialEngine) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_type_5malik_6engine_BinomialEngine.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5malik_6engine_BinomialEngine.tp_dict, __pyx_vtabptr_5malik_6engine_BinomialEngine) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  if (PyObject_SetAttrString(__pyx_m, "BinomialEngine", (PyObject *)&__pyx_type_5malik_6engine_BinomialEngine) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_ptype_5malik_6engine_BinomialEngine = &__pyx_type_5malik_6engine_BinomialEngine;
  __pyx_vtabptr_5malik_6engine_EuropeanBinomialEngine = &__pyx_vtable_5malik_6engine_EuropeanBinomialEngine;
  __pyx_vtable_5malik_6engine_EuropeanBinomialEngine.__pyx_base = *__pyx_vtabptr_5malik_6engine_BinomialEngine;
  __pyx_vtable_5malik_6engine_EuropeanBinomialEngine.__pyx_base.__pyx_base.calculate = (double (*)(struct __pyx_obj_5malik_6engine_PricingEngine *, struct __pyx_obj_5malik_6option_Option *, struct __pyx_obj_5malik_10marketdata_MarketData *))__pyx_f_5malik_6engine_22EuropeanBinomialEngine_calculate;
  __pyx_type_5malik_6engine_EuropeanBinomialEngine.tp_base = __pyx_ptype_5malik_6engine_BinomialEngine;
  if (PyType_Ready(&__pyx_type_5malik_6engine_EuropeanBinomialEngine) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_type_5malik_6engine_EuropeanBinomialEngine.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_5malik_6engine_EuropeanBinomialEngine.tp_dict, __pyx_vtabptr_5malik_6engine_EuropeanBinomialEngine) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  if (PyObject_SetAttrString(__pyx_m, "EuropeanBinomialEngine", (PyObject *)&__pyx_type_5malik_6engine_EuropeanBinomialEngine) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_ptype_5malik_6engine_EuropeanBinomialEngine = &__pyx_type_5malik_6engine_EuropeanBinomialEngine;
  /*--- Type import code ---*/
  __pyx_ptype_5malik_6payoff_Payoff = __Pyx_ImportType("malik.payoff", "Payoff", sizeof(struct __pyx_obj_5malik_6payoff_Payoff), 1); if (unlikely(!__pyx_ptype_5malik_6payoff_Payoff)) __PYX_ERR(2, 1, __pyx_L1_error)
  __pyx_ptype_5malik_6payoff_VanillaCallPayoff = __Pyx_ImportType("malik.payoff", "VanillaCallPayoff", sizeof(struct __pyx_obj_5malik_6payoff_VanillaCallPayoff), 1); if (unlikely(!__pyx_ptype_5malik_6payoff_VanillaCallPayoff)) __PYX_ERR(2, 5, __pyx_L1_error)
  __pyx_vtabptr_5malik_6payoff_VanillaCallPayoff = (struct __pyx_vtabstruct_5malik_6payoff_VanillaCallPayoff*)__Pyx_GetVtable(__pyx_ptype_5malik_6payoff_VanillaCallPayoff->tp_dict); if (unlikely(!__pyx_vtabptr_5malik_6payoff_VanillaCallPayoff)) __PYX_ERR(2, 5, __pyx_L1_error)
  __pyx_ptype_5malik_6payoff_VanillaPutPayoff = __Pyx_ImportType("malik.payoff", "VanillaPutPayoff", sizeof(struct __pyx_obj_5malik_6payoff_VanillaPutPayoff), 1); if (unlikely(!__pyx_ptype_5malik_6payoff_VanillaPutPayoff)) __PYX_ERR(2, 9, __pyx_L1_error)
  __pyx_vtabptr_5malik_6payoff_VanillaPutPayoff = (struct __pyx_vtabstruct_5malik_6payoff_VanillaPutPayoff*)__Pyx_GetVtable(__pyx_ptype_5malik_6payoff_VanillaPutPayoff->tp_dict); if (unlikely(!__pyx_vtabptr_5malik_6payoff_VanillaPutPayoff)) __PYX_ERR(2, 9, __pyx_L1_error)
  __pyx_ptype_5malik_6option_Option = __Pyx_ImportType("malik.option", "Option", sizeof(struct __pyx_obj_5malik_6option_Option), 1); if (unlikely(!__pyx_ptype_5malik_6option_Option)) __PYX_ERR(3, 3, __pyx_L1_error)
  __pyx_vtabptr_5malik_6option_Option = (struct __pyx_vtabstruct_5malik_6option_Option*)__Pyx_GetVtable(__pyx_ptype_5malik_6option_Option->tp_dict); if (unlikely(!__pyx_vtabptr_5malik_6option_Option)) __PYX_ERR(3, 3, __pyx_L1_error)
  __pyx_ptype_5malik_10marketdata_MarketData = __Pyx_ImportType("malik.marketdata", "MarketData", sizeof(struct __pyx_obj_5malik_10marketdata_MarketData), 1); if (unlikely(!__pyx_ptype_5malik_10marketdata_MarketData)) __PYX_ERR(4, 1, __pyx_L1_error)
  __pyx_ptype_5malik_10marketdata_HestonData = __Pyx_ImportType("malik.marketdata", "HestonData", sizeof(struct __pyx_obj_5malik_10marketdata_HestonData), 1); if (unlikely(!__pyx_ptype_5malik_10marketdata_HestonData)) __PYX_ERR(4, 7, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init malik.engine", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init malik.engine");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
